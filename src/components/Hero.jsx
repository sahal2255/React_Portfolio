      ...
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-100 md:text-7xl text-5xl tracking-tight mb-4" // Updated to light gray
          >
            HEY, I AM <br />
            <span className="text-gray-400">SAHAL V V</span> {/* Updated to gray */}
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-row items-center gap-6 my-4 md:mb-0 rounded-lg"
          >
            <motion.a
              whileHover={{ scale: 1.05, boxShadow: "0px 0px 8px rgba(0, 0, 0, 0.3)" }}
              href="/Sahal_Resume.pdf"
              className="z-10 cursor-pointer font-bold text-gray-200 md:w-auto p-4 border border-gray-400 rounded-xl" // Updated to gray border
              download
            >
              Download CV
            </motion.a>
        ...
        <motion.img
          src={ProfileImg}
          className="w-[300px] md:w-[450px] rounded-full border-2 border-gray-400" // Added border for emphasis
